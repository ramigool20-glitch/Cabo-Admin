...
export default async function TransaccionesPage(
  ...
  function buildQuery(includeAtribuido: boolean) {
    const cols = includeAtribuido
      ? 'id, tipo, monto, moneda, fecha, concepto, categoria, negocio_id, cuenta_id, monto_mxn_equivalente, tipo_cambio_usado, atribuido_a, split_grupo_id, negocios(nombre, tipo), cuentas(nombre)'
      : 'id, tipo, monto, moneda, fecha, concepto, categoria, negocio_id, cuenta_id, monto_mxn_equivalente, tipo_cambio_usado, split_grupo_id, negocios(nombre, tipo), cuentas(nombre)'
    let q = supabase
      .from('transacciones')
      .select(cols)
      .gte('fecha', r.desde)
